...
QT_MOC_LITERAL(1, 7, 6), // "Result"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 6) // "Number"

    },
    "MyTask\0Result\0\0Number"
};
...
void MyTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyTask::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTask::Result)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MyTask::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_MyTask.data,
    qt_meta_data_MyTask,
    qt_static_metacall,
    nullptr,
    nullptr
