...
QT_MOC_LITERAL(1, 9, 11), // "valueChange"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "MyThread\0valueChange\0"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::valueChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::valueChange(int _t1)
{
