...
QT_MOC_LITERAL(1, 7, 11), // "linkClicked"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "Filter\0linkClicked\0"
};
...
void Filter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Filter::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Filter::linkClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Filter::linkClicked(const QString & _t1)
{
